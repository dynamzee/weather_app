...
## ✨ Features
* **Real-Time Data:** Fetches current temperature and weather conditions using the OpenWeatherMap API.
* **Global Search:** Find weather information for any city across the globe.
* **Responsive UI:** Clean design that works on both desktop and mobile browsers.
* **Cloud Hosted:** Fully deployed and managed via Render.
